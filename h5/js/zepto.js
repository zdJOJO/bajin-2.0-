...
//弹框效果，使用js来生成页面元素，代替alert对话框
function alert_replace(from,message,time){
	var box_div = $('<div class="box_div" style="position:fixed;top:0;bottom:0;z-index:1001;left:0;right:0;opacity:1;"><div style="position:absolute;top:200px;left:10%;border:1px solid #ddd;border-radius:2px;width:80%;height:100px;background-color:#fff;"><p style="-webkit-margin-before: 0;-webkit-margin-after: 0;height:50px;font-size:16px;line-height:50px;background-color:#eee;text-indent:20px;">'+from+'</p><p style="-webkit-margin-before: 0;-webkit-margin-after: 0;height:50px;line-height:50px;text-indent:20px;font-size:16px;">'+message+'</p></div></div>');
	$("body").prepend(box_div);
	setTimeout('$(".box_div").hide(200);',time*1000);
	$(".box_div").bind("click",function(){
		$(".box_div").hide(200);
	})
}