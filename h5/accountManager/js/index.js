    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            var str = '<div class="headPicBox"><img src="'+headPicPath+'"></div>' +
                ...
                '<ul class="num"><li><span>29</span><span>客户</span></li>' +
                '<li><span>29</span><span>排行榜</span></li></ul>' +
            ...
            $('#invite').click(function () {
                ...
                try {
                    javascript: window.handler.showShareBoard(
                        ...
                        headPicPath,
                        portStr+'/accountManager/download.html');    //Android
                }catch (e){
                    //todo
                }
                try {
                    showShareBoard(
                        ...
                        res.data.userModel.userName+'邀请您加入白金尊享',
                        headPicPath,
                        portStr+'/accountManager/download.html'
                    );   //IOS
                }catch (e){
                    //todo
                }
